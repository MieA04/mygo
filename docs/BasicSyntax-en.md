...
- `+`, `-`, `*`, `/`, `%`
- **Increment/Decrement**: `++`, `--` (Only supported as suffix, e.g., `i++`)
...
- **Null-Safe Operators**:
  - `?!`: Try to unwrap and handle error.
...
- **repeat**: Strategy for handling repeated definitions.

These directives will be detailed in [TraitSystem-en.md](./TraitSystem-en.md).
